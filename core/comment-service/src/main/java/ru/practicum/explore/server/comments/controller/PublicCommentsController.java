...
public class PublicCommentsController {
    ...
    public Collection<PublicCommentResponseDto> getEventComments(@PathVariable Long eventId,
                                                                 @Valid
                                                                 ...
                                                                 Integer size) {
        log.info("Запрос публичных комментариев: eventId={}, from={}, size={}", eventId, from, size);
