...
public class PrivateCommentsController {
    ...
    public FullCommentResponseDto addComment(@Valid @RequestBody RequestCommentDto requestCommentDto,
                                             @PathVariable Long eventId,
                                             @RequestHeader(EWM_USER_HEADER) Long userId) {
    ...
    public FullCommentResponseDto updateComment(@RequestHeader(EWM_USER_HEADER) Long userId,
                                                @PathVariable Long commentId,
                                                @RequestBody @Valid RequestCommentDto updateCommentDto) {
    ...
    public void deleteComment(@RequestHeader(EWM_USER_HEADER) Long userId,
                              @PathVariable Long commentId) {
    ...
    public List<FullCommentResponseDto> getUserComments(@RequestHeader(EWM_USER_HEADER) Long userId,
