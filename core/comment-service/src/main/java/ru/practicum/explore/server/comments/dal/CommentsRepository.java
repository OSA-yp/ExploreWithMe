...
public interface CommentsRepository extends JpaRepository<Comment, Long> {
    ...
    List<Comment> findAllByCommentatorOrderByCreatedDesc(Long userId, Pageable pageable);

    List<Comment> findAllByCommentatorAndStatusOrderByCreatedDesc(Long userId, CommentStatus status, Pageable pageable);
