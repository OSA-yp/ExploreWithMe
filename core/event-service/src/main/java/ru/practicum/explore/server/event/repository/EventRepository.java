package ru.practicum.explore.server.event.repository;
    ...
    class Specs {
        ...
        static Specification<Event> text(String text) {
            ...
            return (entity, query, cb) ->
                    cb.or(
                            cb.like(cb.lower(entity.get("annotation")), like),
                            cb.like(cb.lower(entity.get("description")), like)
                    );
        }

        static Specification<Event> paid(Boolean paid) {
            return paid == null ? null :
                    (entity, query, cb) -> cb.equal(entity.get("paid"), paid);
        }
    }
}
