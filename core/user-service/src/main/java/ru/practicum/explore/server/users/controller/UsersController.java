...
public class UsersController {
    ...
    public UserResponseDto addUser(@Valid @RequestBody NewUserRequestDto newUser) {
        return userService.addUser(UserMapper.toUser(newUser));
    }

    @GetMapping("/admin/users")
    public Collection<UserResponseDto> getUsers(@RequestParam(name = "ids", required = false) Collection<Long> ids,
